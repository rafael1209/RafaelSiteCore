...
public class GoogleDriveService : IStorage
{
    ...
    public GoogleDriveService(GoogleDriveCredentials googleDriveCredential, string drivelerId)
    {

        _googleDriveFolderId = drivelerId;
        ...
        try
        {
            ...
            var credential = GoogleCredential.FromStream(stream).CreateScoped(new[]
            {
